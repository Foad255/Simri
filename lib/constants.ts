 ...
 */
export const MRI_MODALITIES: MriModality[] = ["T1c", "T1n", "T2f", "T2w"]; // As per your provided list
 ...
 */
export const ML_SERVICE_REQUIRED_MODALITIES: MriModalityKey[] = ['t1c', 't1n', 't2f', 't2w'];
...
export const SAMPLE_PATIENTS: SamplePatient[] = [
  {
    ...
    s3Keys: {
      t1c: 'patients/Sample_Patient1/t1c-BraTS-GLI-00012-000-t1c.nii.gz',
      t1n: 'patients/Sample_Patient1/t1n-BraTS-GLI-00012-000-t1n.nii.gz',
      t2f: 'patients/Sample_Patient1/t2f-BraTS-GLI-00012-000-t2f.nii.gz',
      t2w: 'patients/Sample_Patient1/t2w-BraTS-GLI-00012-000-t2w.nii.gz',
      // If you have a 'seg' file for this sample and want to use it for thumbnails:
      // seg: 'patients/670/seg-BraTS-GLI-00000-000-seg.nii.gz',
    },
  },
  {
    ...
    s3Keys: {
      t1c: 'patients/Sample_Patient2/t1c-BraTS-GLI-00000-000-t1c.nii.gz', // Using generic filename part for example consistency
      t1n: 'patients/Sample_Patient2/t1n-BraTS-GLI-00000-000-t1n.nii.gz',
      t2f: 'patients/Sample_Patient2/t2f-BraTS-GLI-00000-000-t2f.nii.gz',
      t2w: 'patients/Sample_Patient2/t2w-BraTS-GLI-00000-000-t2w.nii.gz',
      // seg: 'patients/703/seg-BraTS-GLI-00000-000-seg.nii.gz', // Optional 'seg' key
    },
  },
